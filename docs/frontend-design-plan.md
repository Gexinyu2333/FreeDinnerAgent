...
当前实现状态：F1-F10 已完成。前端已经接入真实后端 API，覆盖 Auth、Web Chat、Providers、Agent Config、Memory、Knowledge、Market、Tools、Tasks、Channels 和 Workspace；支持中文/英文切换、统一 loading/empty/error/toast、统一表单 Field、移动端侧边导航抽屉，并通过 `npm run build` 验证。
