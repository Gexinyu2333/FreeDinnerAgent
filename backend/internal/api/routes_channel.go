...
func registerChannelRoutes(router *gin.RouterGroup, h Handlers) {
	...
	router.PATCH("/me/channel-connections/:connection_id", h.Channel.UpdateConnection)
	router.DELETE("/me/channel-connections/:connection_id", h.Channel.DeleteConnection)
	...
	router.DELETE("/me/channel-connections/:connection_id/policies/:policy_id", h.Channel.DeletePolicy)
	router.GET("/me/channel-connections/:connection_id/external-conversations", h.Channel.ExternalConversations)
	router.GET("/me/channel-connections/:connection_id/external-conversations/:external_conversation_id/messages", h.Channel.ExternalConversationMessages)
	router.POST("/me/channel-connections/:connection_id/external-conversations/:external_conversation_id/outbox-drafts", h.Channel.CreateOutboxDraft)
